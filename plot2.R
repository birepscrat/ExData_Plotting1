...
png("plot2.png")
plot(as.POSIXct(cleanedData$timestamps, origin = "1970-01-01",tz="utc"),cleanedData$Global_active_power, type = "n",ylab="Global Active Power (kilowatts)",xlab="")
lines(as.POSIXct(cleanedData$timestamps, origin = "1970-01-01",tz="utc"),cleanedData$Global_active_power, type="l")
dev.off()
